...
public class RobotContainer implements Loggable {
  ...
  private void configureBindings() {
    ...
    m_operatorController.y().onTrue(new SetShoulderPosition(4).andThen(new SetArmExtension(0.18)).alongWith(new ClawSensorGrab()));  //Get Game Piece from human / feed station
